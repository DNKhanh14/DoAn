<div class="container-fluid">
    <div class="page-title-bar"><h1>Sửa nhân viên</h1></div>
    <div class="card card-salon shadow mb-4">
        <div class="card-body">
            ...
            <form method="POST" action="<?= admin_route('employees', ['do' => 'Edit', 'ma_nhan_vien' => $employee['ma_nhan_vien']]) ?>">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>Tên</label>
                            <input type="text" class="form-control" name="ten" required value="<?= htmlspecialchars($employee['ten']) ?>">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>Họ đệm</label>
                            <input type="text" class="form-control" name="ho_dem" required value="<?= htmlspecialchars($employee['ho_dem']) ?>">
                ...
                <div class="form-group">
                    <label>Chức vụ</label>
                    <input type="text" class="form-control" name="chuc_vu" list="jobTitleList" value="<?= htmlspecialchars($employee['chuc_vu'] ?? '') ?>" placeholder="VD: Thợ chính, Lễ tân...">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="so_dien_thoai" required pattern="\d{10}" title="Số điện thoại phải đủ 10 chữ số" value="<?= htmlspecialchars($employee['so_dien_thoai']) ?>">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>Email</label>
                            <input type="text" class="form-control" name="email" required value="<?= htmlspecialchars($employee['email']) ?>">
                            <?php if (!empty($errors['email'])): ?><div class="invalid-feedback" style="display:block;"><?= $errors['email'] ?></div><?php endif; ?>
                        </div>
                    </div>
                </div>
                <button type="submit" name="edit_employee_sbmt" class="btn btn-primary">Lưu thay đổi</button>
            </form>
